...
const Shop = () => {
    const { data: items, error: itemError, loading: itemLoading } = Items();
                    ...
                    <div className="p-4 border-l border-black ">
                         ...
                         <div className="p-4 grid grid-cols-3 gap-4">
                            ...
                            {items.map((item, index) => (
                                <div className='items' data-testid={`item-${index}`} key={index}>
                                    <Link to={`/products/${item.id}`} className="flex flex-col gap-5 justify-end items-start">
