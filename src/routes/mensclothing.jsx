...
const NewMensClothing = () => {
    const { data: items, error: itemError, loading: itemLoading } = MensClothing();
                    ...
                    <div className="p-4 border-l border-black ">
                         ...
                         <div className="p-4 grid grid-cols-3 gap-4">
                            ...
                            {items.map((item, index) => (
                                 <div className='mensclothing-items' data-testid={`mensclothing-item-${index}`} key={index}>
...
export default NewMensClothing;
