...
const NewWomensClothing = () => {
    const { data: items, error: itemError, loading: itemLoading } = WomensClothing();
                    ...
                    <div className="p-4 border-l border-black ">
                         ...
                         <div className="p-4 grid grid-cols-3 gap-4">
                            ...
                            {items.map((item, index) => (
                                <div className='womensclothing-items' data-testid={`womensclothing-item-${index}`} key={index}>
...
export default NewWomensClothing;
